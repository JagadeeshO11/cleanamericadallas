...
export default function WorkerProfile() {
  ...
  return (
    <div className="worker-page">
      ...
      {showLogout && <div className="modal-overlay" onClick={() => setShowLogout(false)}><div className="confirm-modal" onClick={e => e.stopPropagation()}><h3>Logout?</h3><p>Are you sure you want to logout?</p><div className="cm-actions"><button className="cm-cancel" onClick={() => setShowLogout(false)}>Cancel</button><button className="cm-confirm" onClick={handleLogout}>Logout</button></div></div></div>}
    </div>
  );
}
